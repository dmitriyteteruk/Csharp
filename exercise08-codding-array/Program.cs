...
namespace excercise08_array_coding
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			char[] Array_With_Symbols = new char[All_Symbols_String.Length]; // длина массива + 1, чтобы была возможность выйти за границу 19 индекса.
			...
			//string[,] DualArray = new string[All_Symbols_String.Length, 2];

			//Dictionary<string, int> DictNew = new Dictionary<string, int>();
			...
			for (int i = 0; i < counter_max_sum - 1; i++)
